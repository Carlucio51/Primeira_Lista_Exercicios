...
let sentinela=parseFloat(prompt("Digite valor minimo que o produto pode ser vendido "));

for(i=1; i <= semanas ; i++){
    preco = preco - (preco*5/100);
    if(preco < sentinela){ // (Valor sentinela para condição de parada.)
        break
    }
    alert(`${i}, preço ${preco.toFixed(2)}`)       
}
